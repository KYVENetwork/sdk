...
var KyveClient = /** @class */ (function () {
    function KyveClient(client, account, signer) {
    ...
    KyveClient.prototype.verifyString = function (signature, data, pubKey) {
        return __awaiter(this, void 0, void 0, function () {
            var signDoc, signBytes, hashedMessage, sig;
            return __generator(this, function (_a) {
                signDoc = (0, proto_signing_1.makeSignDoc)(new Uint8Array(Buffer.from(data, "utf-8")), new Uint8Array(), "", 0);
                ...
                return [2 /*return*/, crypto_1.Secp256k1.verifySignature(sig, hashedMessage, pubKey)];
            });
        });
    };
    return KyveClient;
